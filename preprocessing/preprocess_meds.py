...
def f_preprocess_meds(x):
    if x=="HOSP":
        df_meds=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\df_meds_hosp_pop.pkl")
    elif x=="ADM":
        df_meds=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\df_meds_adm_pop.pkl")
   
    elif x=="DIS":  
        df_meds=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\df_meds_dis_pop.pkl")

        
    
    else: 
        print("define which medications - ADM or HOSP or DIS" )
    ...
    df_ATC1.to_pickle(output_path+x+"_ATC1.pkl")
    
    df_ATC2.to_pickle(output_path+x+"_ATC2.pkl")
