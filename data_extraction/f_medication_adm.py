...
global_path_processes_file_pop=r"O:\OrlI\readmissions\preprocessed\medications\df_meds_adm_pop.pkl"
...
def f_get_meds_adm_full():
  ...
  where DrugType_Code='1' and DrugCode <> '-1'
...
#temp
#df_pop=pd.read_pickle("C:/Users/orlyk/readmissions/project/preprocessed/population/population_for_model/df_basic_data_short.pkl")
#l_casenum=df_pop.CaseNum.unique()

def f_get_meds_adm_pop(l_casenum=[]):
    df = f_get_meds_adm_full()
