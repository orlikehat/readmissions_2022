...
def f_preprocess_CCI():
    df_CCI =pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\CCI\df_CCI_pop.pkl")
...
#     
    ...
    df_CCI.to_pickle(r"O:\OrlI\readmissions\preprocessed\CCI\CCI_for_model\CCI_for_model.pkl")    
