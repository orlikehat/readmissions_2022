...
def f_preprocess_VS():
    ...
    df=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\vital_signs\df_vital_signs_pop_covid.pkl")
    df_namer=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\vital_signs\df_vital_signs_pop_namer_covid.pkl")
    ...
    df_VS_short.to_pickle(output_path+"vs_processed_short_covid.pkl")
