...
def f_preprocess_blood_count():
    path = "O:/OrlI/readmissions/preprocessed/labs/blood_count/blood_count_preprocessed"
...
#                    df_fin=df_fin.drop(columns=["temp_first","temp_min","temp_last","temp_max"])
    ...
    #df_blood_count.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_count\lab_blood_count_for_model\blood_count_results_with_dates.pkl")
    #df_blood_count_results_only.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_count\lab_blood_count_for_model\blood_count_results_only.pkl")
