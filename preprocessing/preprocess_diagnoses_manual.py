...
def f_preprocess_diagnoses_manual():
    ...
    df_disch_table.to_pickle(output_path+"disch_table_manual.pkl")
    df_adm_table.to_pickle(output_path+"adm_table_manual.pkl")
    df_bg_table.to_pickle(output_path+"bg_table_manual.pkl")
