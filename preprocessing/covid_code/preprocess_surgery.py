...
def f_preprocess_surgery():
    ...
    df=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\surgery\df_surgery_pop_covid.pkl")
    ...
    df_fin.to_pickle(r"O:\OrlI\readmissions\preprocessed\surgery\surgery_for_model\suregry_preprocessed_covid.pkl")
