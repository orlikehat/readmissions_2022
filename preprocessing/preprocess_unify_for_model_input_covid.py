...
if IS_RUN_ISHPUZIM:
    ...
    df_ishpuzim=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\ishpuzim_indicators\ishpuzim_for_model\ishpuzim_preprocessed.pkl")
...
if IS_RUN_MEDS_HOSP:
    ...
    df_meds_hosp=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\meds_for_model\HOSP_ATC1.pkl")
...
if IS_RUN_MEDS_ADM:
    ...
    df_meds_adm=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\meds_for_model\ADM_ATC1.pkl")
...
if IS_RUN_MEDS_DIS:
    ...
    df_meds_adm=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\meds_for_model\DIS_ATC1.pkl")
...
df_merged.drop(columns=['VS_CaseNum', 'LABS_CaseNum_x','LABS_CaseNum_y','LABS_CaseNum',
                        ...
                        "COUNT_MEDS_HOSP_CaseNum","MEDS_DIS_CaseNum"], inplace=True)#"PROCED_CaseNum","MEDS_HOSP_CaseNum","MEDS_ADM_CaseNum",,"SURGERY_CaseNum","DIAG_CaseNum_dis",
