...
def f_preprocess_diagnoses_count():
    ...
    df_diag=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\diagnoses\df_diagnoses_pop.pkl")
    ...
    df_disch_count.to_pickle(r'O:\OrlI\readmissions\preprocessed\diagnoses\diagnoses_for_model\diagnoses_count_disch.pkl')
    df_adm_count.to_pickle(r'O:\OrlI\readmissions\preprocessed\diagnoses\diagnoses_for_model\diagnoses_count_adm.pkl')
    df_bg_count.to_pickle(r'O:\OrlI\readmissions\preprocessed\diagnoses\diagnoses_for_model\diagnoses_count_bg.pkl')
