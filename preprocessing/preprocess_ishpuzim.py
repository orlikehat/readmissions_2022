...
def f_preprocess_ishpuzim():
    ...
    df=pd.read_pickle(r"O:/OrlI/readmissions/preprocessed/ishpuzim_indicators/df_ishpuzim_pop.pkl")
    ...
    df.to_pickle(r"O:\OrlI\readmissions\preprocessed\ishpuzim_indicators\ishpuzim_for_model\ishpuzim_preprocessed.pkl")
