...
def f_preprocess_procedures():
    ...
    output_path="O:/OrlI/readmissions/preprocessed/procedures_specs/procedures_for_model/procedures_preprocessed_covid.pkl"
    
    df_proced=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\procedures_specs\df_procedures_specs_pop_covid.pkl")
