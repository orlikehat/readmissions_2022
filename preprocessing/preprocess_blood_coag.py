...
def f_preprocess_blood_coag():
    path = "O:/OrlI/readmissions/preprocessed/labs/blood_coagulation/blood_coag_preprocessed"
    ...
    df_blood_coag.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_coagulation\blood_coag_for_model\blood_coag_results_with_dates.pkl")
    df_blood_coag_results_only.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_coagulation\blood_coag_for_model\blood_coag_results_only.pkl")
