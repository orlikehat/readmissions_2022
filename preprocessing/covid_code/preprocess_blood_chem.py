...
def f_preprocess_blood_chem():
    path = "O:/OrlI/readmissions/preprocessed/labs/blood_chem/blood_chem_preprocessed/covid"
    ...
    df_blood_chem.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_chem\lab_blood_chem_for_model\covid\blood_chem_results_with_dates_covid.pkl")
    df_blood_chem_results_only.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_chem\lab_blood_chem_for_model\covid\blood_chem_results_only_covid.pkl")
