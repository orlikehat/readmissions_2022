...
def f_preprocess_blood_coag():
    path = "O:/OrlI/readmissions/preprocessed/labs/blood_coagulation/blood_coag_preprocessed/covid"
    ...
    df_blood_coag.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_coagulation\blood_coag_for_model\covid\blood_coag_results_with_dates_covid.pkl")
    df_blood_coag_results_only.to_pickle(r"O:\OrlI\readmissions\preprocessed\labs\blood_coagulation\blood_coag_for_model\covid\blood_coag_results_only_covid.pkl")
