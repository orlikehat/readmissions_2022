...
def f_preprocess_meds_count():
    df_meds_hosp=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\df_meds_hosp_pop_covid.pkl")
    df_meds_adm=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\df_meds_adm_pop_covid.pkl")
    df_meds_dis=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\medications\df_meds_dis_pop_covid.pkl")
    ...
    df_disch_count.to_pickle(r'O:\OrlI\readmissions\preprocessed\medications\meds_for_model\meds_count_disch_covid.pkl')
    df_adm_count.to_pickle(r'O:\OrlI\readmissions\preprocessed\medications\meds_for_model\meds_count_adm_covid.pkl')
    df_meds_hosp_count.to_pickle(r'O:\OrlI\readmissions\preprocessed\medications\meds_for_model\meds_count_hosp_covid.pkl')
