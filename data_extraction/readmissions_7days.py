...
global output_path
output_path="O:/OrlI/readmissions/preprocessed/population/population_7_days/"
...
def f_create_research_population():
    ...
    df.loc[df['ReAdmPlan7DFlg'] == 1, 'BASE_FLG'] = 0
        ...
        for i_index in range(len(l_tmp_BASE_indexes)):
            ...
            for index_REF in l_tmp_REF_indexes:
                ...
                if dt_time_to_readmin < dt.timedelta(days=0):
                    continue
                if dt_time_to_readmin < dt.timedelta(days=8):#orli
