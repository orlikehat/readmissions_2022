...
def f_preprocess_basic_data():
    ...
    df_demo=pd.read_pickle(r"O:\OrlI\readmissions\preprocessed\demographics\df_demographics_pop_covid.pkl")
    ...
    df_short.to_pickle(output_path+"df_basic_data_short_covid.pkl")
